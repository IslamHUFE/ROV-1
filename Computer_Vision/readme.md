...
A fine-tuned YOLO-based object detection model specifically designed for autonomous underwater vehicles (ROVs) to detect and classify underwater trash in real-time.
